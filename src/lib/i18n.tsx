...
const DICT = {
  id: {
    ...
    contactName: "Nama", contactEmail: "Email", contactMessage: "Pesan", contactSubmit: "Kirim pesan",
    ...
    chordFamily: "Chord Family", usedChords: "Chord yang Digunakan", showChordFamily: "Tampilkan", hideChordFamily: "Sembunyikan",
  },
  en: {
    ...
    contactName: "Name", contactEmail: "Email", contactMessage: "Message", contactSubmit: "Send message",
    ...
    chordFamily: "Chord Family", usedChords: "Chords Used", showChordFamily: "Show", hideChordFamily: "Hide",
  },
} as const;
