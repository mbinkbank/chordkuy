...
const DICT = {
  id: {
    ...
    contactSent: "Pesan berhasil terkirim. Kami akan membalas 2-3 hari kerja.", contactError: "Nama dan pesan wajib diisi.", contactFailed: "Pesan gagal dikirim. Coba lagi.",
  ...
  en: {
    ...
    contactSent: "Message sent successfully. We'll reply within 2-3 business days.", contactError: "Name and message are required.", contactFailed: "Message failed to send. Please try again.",
