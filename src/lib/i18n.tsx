...
const DICT = {
  id: {
    ...
    sidebarArtist: "Artis", sidebarDetail: "Detail lagu", sidebarOriginalKey: "Kunci Asli", sidebarCurrentKey: "Kunci Kini", sidebarCapo: "Capo",
    sidebarTuning: "Tuning", sidebarGenre: "Genre", relatedChords: "Lagu terkait", viewArtist: "Lihat artis →",
  ...
  en: {
    ...
    sidebarArtist: "Artist", sidebarDetail: "Song detail", sidebarOriginalKey: "Original Key", sidebarCurrentKey: "Current Key", sidebarCapo: "Capo",
    sidebarTuning: "Tuning", sidebarGenre: "Genre", relatedChords: "Related songs", viewArtist: "View artist →",
